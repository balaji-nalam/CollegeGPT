...
-- Ready for Production Execution on Supabase
...
-- 4. Document Chunks Table (Vector Store with strict 768-dim embeddings)
...
-- HNSW Vector Cosine Index for Fast Semantic Search
